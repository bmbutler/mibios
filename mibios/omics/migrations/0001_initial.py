...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', mibios.models.AutoField(primary_key=True, serialize=False)),
                ('fwd_qc0_fastq', mibios.omics.fields.DataPathField(base='READS', default=None, null=True)),
                ('rev_qc0_fastq', mibios.omics.fields.DataPathField(base='READS', default=None, null=True)),
                ('fwd_qc1_fastq', mibios.omics.fields.DataPathField(base='READS', default=None, null=True)),
                ('rev_qc1_fastq', mibios.omics.fields.DataPathField(base='READS', default=None, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', mibios.models.AutoField(primary_key=True, serialize=False)),
                ('count_contig', models.PositiveIntegerField(verbose_name='number of contigs')),
                ('count_gene', models.PositiveIntegerField(verbose_name='number of genes')),
                ('len_contig', models.PositiveIntegerField(verbose_name='total length of all contigs')),
                ('len_gene', models.PositiveIntegerField(verbose_name='total length of all genes')),
                ('mean_fpkm_contig', models.FloatField(verbose_name='aggregated fpkm across all contigs')),
                ('mean_fpkm_gene', models.FloatField(verbose_name='aggregated fpkm across all genes')),
                ('wmedian_fpkm_contig', models.FloatField(verbose_name='weighted median fpkm across all contigs')),
                ('wmedian_fpkm_gene', models.FloatField(verbose_name='weighted median fpkm across all genes')),
                ('norm_reads_contig', models.FloatField(verbose_name='sum of reads mapping to contigs, normalized')),
                ('norm_reads_gene', models.FloatField(verbose_name='sum of reads mapping to genes, normalized')),
                ('norm_frags_contig', models.FloatField(verbose_name='sum of fragments mapping to contigs, normalized')),
                ('norm_frags_gene', models.FloatField(verbose_name='sum of fragments mapping to genes, normalized')),
                ('sample', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.OMICS_SAMPLE_MODEL)),
