...
urlpatterns = [
    ...
    path('<str:dataset>/export-form/', views.ExportFormView.as_view(),
         name='export_form'),
    path('<str:dataset>/export/', views.ExportView.as_view(),
         name='export'),
    path('<str:dataset>/mean/<str:avg_by>/export-form/',
         views.AverageExportFormView.as_view(), name='average_export_form'),
    path('<str:dataset>/mean/<str:avg_by>/export/',
