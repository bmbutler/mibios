    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dataset_id', mibios_umrad.fields.AccessionField(help_text='GLAMR accession to data set/study/project', verbose_name='Dataset ID')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', mibios.models.AutoField(primary_key=True, serialize=False)),
                ('reference_id', mibios_umrad.fields.AccessionField(prefix='paper_')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('term', models.CharField(db_index=True, max_length=32)),
