    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('study_id', models.PositiveIntegerField(help_text='GLAMR accession to data set/study/project', unique=True)),
                ('bioproject', mibios_umrad.fields.AccessionField(blank=True, default=None, null=True)),
                ('jgi_project', mibios_umrad.fields.AccessionField(blank=True, default=None, null=True)),
                ('gold_id', mibios_umrad.fields.AccessionField(blank=True, default=None, null=True)),
