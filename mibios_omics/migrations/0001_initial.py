# Generated by Django 2.2.26 on 2022-08-19 15:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sample_id', models.CharField(blank=True, default=None, help_text='sample ID given by study', max_length=256, null=True, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lin_avg_prgc', models.DecimalField(decimal_places=3, max_digits=10)),
                ('lin_avg_depth', models.DecimalField(decimal_places=3, max_digits=10)),
                ('lin_avg_rpkm', models.DecimalField(decimal_places=3, max_digits=8)),
                ('lin_gnm_pgc', models.DecimalField(decimal_places=2, max_digits=8)),
                ('lin_sum_sco', models.DecimalField(decimal_places=4, max_digits=18)),
                ...
                ('con_rpkm', models.DecimalField(decimal_places=4, max_digits=12)),
                ('gen_rpkm', models.DecimalField(decimal_places=4, max_digits=12)),
                ('gen_dept', models.DecimalField(decimal_places=4, max_digits=12)),
                ('sample', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.OMICS_SAMPLE_MODEL)),
                ('taxname', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='abundance', to='mibios_umrad.Taxon')),
            ],
            options={
                'abstract': False,
                'default_manager_name': 'objects',
                'unique_together': {('sample', 'taxname')},
            },
        ),
        migrations.CreateModel(
            name='NCRNA',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ref', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mibios_umrad.UniRef100')),
            ],
            options={
