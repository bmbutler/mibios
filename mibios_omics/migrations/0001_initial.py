# Generated by Django 2.2.24 on 2021-12-03 21:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cluster_id', mibios_omics.fields.AccessionField(max_length=50, prefix='CLUSTER', unique=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('frags_mapped', models.PositiveIntegerField(blank=True, default=None, null=True)),
                ('fpkm', models.DecimalField(blank=True, decimal_places=4, default=None, max_digits=10, null=True)),
                ('gene_id', mibios_omics.fields.AccessionField(max_length=50, prefix='CLUSTER', unique=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('domain', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tax_dom_rel', to='mibios_omics.SimpleTaxonomyName')),
                ('family', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tax_fam_rel', to='mibios_omics.SimpleTaxonomyName')),
                ('genus', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tax_gen_rel', to='mibios_omics.SimpleTaxonomyName')),
                ('klass', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tax_cls_rel', to='mibios_omics.SimpleTaxonomyName')),
                ('order', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tax_ord_rel', to='mibios_omics.SimpleTaxonomyName')),
                ('phylum', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tax_phy_rel', to='mibios_omics.SimpleTaxonomyName')),
                ('species', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tax_sp_rel', to='mibios_omics.SimpleTaxonomyName')),
                ('strain', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tax_str_rel', to='mibios_omics.SimpleTaxonomyName')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', mibios.models.AutoField(primary_key=True, serialize=False)),
                ('accession', mibios_omics.fields.AccessionField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taxon', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mibios_omics.SimpleTaxonomy')),
            ],
            options={
                'abstract': False,
            },
