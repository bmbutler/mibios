...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        migrations.swappable_dependency(settings.OMICS_SAMPLE_GROUP_MODEL),
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taxon', models.ManyToManyField(related_name='classified_contigcluster', to='mibios_umrad.Taxon')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lca', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mibios_umrad.Taxon')),
                ('sample', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.OMICS_SAMPLE_MODEL)),
                ('taxon', models.ManyToManyField(related_name='classified_gene', to='mibios_umrad.Taxon')),
            ],
            options={
                'default_manager_name': 'objects',
