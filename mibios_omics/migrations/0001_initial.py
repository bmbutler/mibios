# Generated by Django 2.2.25 on 2022-02-28 20:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sample', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.OMICS_SAMPLE_MODEL)),
                ('taxname', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='abundance', to='mibios_umrad.TaxName')),
            ],
            options={
                'abstract': False,
                'default_manager_name': 'objects',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('function', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mibios_umrad.FuncRefDBEntry')),
                ('sample', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.OMICS_SAMPLE_MODEL)),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('compound', models.ForeignKey(on_delete='on_delete', to='mibios_umrad.CompoundEntry')),
                ('sample', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.OMICS_SAMPLE_MODEL)),
            ],
            options={
                'abstract': False,
